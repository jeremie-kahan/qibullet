...
from qibullet.sonar import *
from qibullet.bumper import *
...
class PepperVirtual(RobotVirtual):
    ...
    def subscribeSonar(self):
        """
        Subscribe to the robot's sonars. Calling this method will launch the
        sonar scan process: note that you need the sonar scan to be enabled to
        successfully retrieve sonar data
        """
        self.sonar_manager.subscribe()

    def unsubscribeSonar(self):
        """
        Unsubscribe from the robot's sonars. Calling this method will stop the
        sonar scan process
        """
    ...
    def getRightSonarValue(self):
        ...
        """
        return self.sonar_manager.getRightSonarValue()

    def getLeftSonarValue(self):
        """
        Return a list of the left sonar value (clockwise)
        """
        return self.sonar_manager.getLeftSonarValue()
    ...
    def subscribeBumper(self):
        ...
        successfully retrieve bumper data
        """
